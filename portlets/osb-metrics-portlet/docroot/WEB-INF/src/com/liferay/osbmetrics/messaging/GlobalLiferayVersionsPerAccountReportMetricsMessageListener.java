 ...
 */
public class GlobalLiferayVersionsPerAccountReportMetricsMessageListener
	...
	protected String getEntryReportName() {
		return "[Global] Liferay Versions Per Account";
	}
	...
	protected String getReportDefinitionName() {
		return "OSB_LiferayVersionsPerAccount";
	}
