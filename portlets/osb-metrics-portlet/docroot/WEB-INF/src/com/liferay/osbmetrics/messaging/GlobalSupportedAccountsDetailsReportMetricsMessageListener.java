 ...
 */
public class GlobalSupportedAccountsDetailsReportMetricsMessageListener
	...
	protected String getEntryReportName() {
		return "[Global] Supported Accounts Details by Month";
	}

	@Override
	protected String getReportDefinitionName() {
		return "OSB_SupportedAccountsDetailsByMonth";
	}
