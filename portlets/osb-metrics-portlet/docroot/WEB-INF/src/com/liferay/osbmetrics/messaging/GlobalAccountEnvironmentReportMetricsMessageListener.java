 ...
 */
public class GlobalAccountEnvironmentReportMetricsMessageListener
	...
	protected String getEntryReportName() {
		return "[Global] Account Environment Statistics";
	}

	@Override
	protected String getReportDefinitionName() {
		return "OSB_AccountEnvironmentStatisticsByMonth";
	}
