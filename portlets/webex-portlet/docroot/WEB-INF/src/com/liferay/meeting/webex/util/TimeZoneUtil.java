...
public class TimeZoneUtil {
	...
	private static Map<TimeZoneType.Enum, TimeZone> _timeZones =
		new HashMap<TimeZoneType.Enum, TimeZone>();
	private static Map<String, TimeZoneType.Enum>
		_timeZoneTypeEnumsByShortName =
			new HashMap<String, TimeZoneType.Enum>();
	private static Map<TimeZone, TimeZoneType.Enum>
		_timeZoneTypeEnumsByTimeZone =
			new HashMap<TimeZone, TimeZoneType.Enum>();
