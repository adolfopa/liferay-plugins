		...
		var KaleoDefinitionPreview = A.Component.create(
			{
				...
				prototype: {
					initializer: function() {
						...
						dialog.bodyNode.prepend(
							Lang.sub(
								TPL_MESSAGE,
								{
									message: Liferay.Language.get('press-enter-to-choose-this-field-set-or-use-arrow-keys-to-navigate-throught-the-available-definitions.-press-esc-at-anytime-to-close-this-dialog')
								}
							)
						);
					...
					_onDialogKeyUp: function(event) {
						...
						var selectedIndex = A.Array.indexOf(availableDefinitions, definition);
